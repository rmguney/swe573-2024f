...
<div class="flex justify-center bg-change dark:bg-dark shifting">
    <div class="lg:w-1/2 p-4 lg:py-8">
        <Card.Root class="bg-opacity-90 hover:bg-opacity-100">
            ...
            <Card.Footer>
                <div class="flex h-5 space-x-4 text-lg">
                    <a href="https://github.com/rmguney/SWE573-2024F" class="hover:underline font-bold hover:text-rose-900">Source</a>
                    <Separator orientation="vertical" class="py-4" />
                    <a href="https://github.com/rmguney/SWE573-2024F/wiki" class="hover:underline font-bold hover:text-rose-900">Wiki</a>
                </div>
            </Card.Footer>   
        </Card.Root>
    </div>
